...
lobby ALL=(ALL) NOPASSWD: /usr/bin/ln -sfn /opt/lobby/app/releases/* /opt/lobby/app/current
lobby ALL=(ALL) NOPASSWD: /usr/bin/mv /opt/lobby/app/current.new /opt/lobby/app/current
EOF
